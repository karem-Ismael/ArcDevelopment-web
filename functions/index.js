...
let transporter = nodemailer.createTransport({
    service:"Gmail",
    auth: {
      user: config.user.email, // generated ethereal user
...
exports.sendMail = functions.https.onRequest((request, response) => {
    cors(request,response,()=>{
        const {name,email,
          phone,message,total,service,platforms,
          features,customFeatures,users,category} = request.query
          if(total){
            if(category){
              mailoptions={
                ...mailoptions,
                to:'karem.Ismael95@gmail.com',
                                                ...
                                                >
                                                  ...
                                                  >
                                                    ...
                                                    <tr>
                                                      ...
                                                      >
                                                        Thans for your placing your Estimate request 
                                                      </td>
                                                    </tr>
                                                  </table>
                                                </td>
